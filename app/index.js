...
module.exports = class extends Generator {
  ...
  initializing() {
    // Welcome
    this.log(yosay('Welcome to the webpack generator!'))
  }
  ...
  prompting() {
    ...
    const prompts = {
      ...
      askForType: () => {
        ...
        if (extensionType) {
          ...
          if (extensionTypes.indexOf(extensionType) !== -1) {
            generator.extensionConfig.type = `webpack-${extensionType}`
          } else {
            generator.log(
      ...
      askForProjectDesc: () => {
        ...
        return generator
          .prompt({
            ...
            default: 'A webpack project generated by webpack generator.',
          })
          .then(nameAnswer => {
      ...
      askForPackageManager: () => {
        if (['webpack-loader', 'webpack-plugin'].indexOf(generator.extensionConfig.type) === -1) {
          return Promise.resolve()
        }
  ...
  writing() {
    ...
    switch (this.extensionConfig.type) {
      case 'webpack-loader':
        this._writingWebpackLoader()
        break
      case 'webpack-plugin':
        this._writingWebpackPlugin()
        break
      default:
